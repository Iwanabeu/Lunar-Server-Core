...
{
    public class HpShoot : CycleBehavior
    {
        ...
        protected Tuple<double, int>[] thresholds;
        public HpShoot(double radius, int count = 1, double? shootAngle = null,
            ...
            Cooldown coolDown = new Cooldown(),params Tuple<double,int>[] hp_index)
        {
            this.radius = radius;
            this.count = count;
        ...
        protected override void TickCore(Entity host, RealmTime time, ref object state)
        {
            ...
            if (cool <= 0)
            {
                ...
                if (player != null || defaultAngle != null || fixedAngle != null)
                {
                    ...
                    if(desc==null)
                    {
                        desc = host.ObjectDesc.Projectiles[projectileIndex];
                    }
