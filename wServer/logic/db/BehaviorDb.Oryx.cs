    ...
    partial class BehaviorDb
    {
        private _ Oryx = () => Behav()
            ...
            .Init("Henchman of Oryx",
                new State(
                    new Spawn("Minion of Oryx",1,1,3000),
                    new Spawn("Abomination of Oryx", 1, 1, 3000),
                    new Spawn("Monstrosity of Oryx", 1, 1, 3000),
                    new Spawn("Vintner of Oryx", 1, 1, 3000),
                    new Spawn("Aberrant of Oryx", 1, 1, 3000),
                    new Prioritize(
