    ...
    partial class BehaviorDb
    {
            ...
            .Init("shtrs Bridge Sentinel",
                new State(
                    ...
                    new State("Close Bridge",
                        ...
                        new TimedTransition(50, "Close Bridge2")
                        ),
                    new State("Close Bridge2",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shtrs Bridge Closer 2", "Closer"),
                        new TimedTransition(50, "Close Bridge3")
                        ),
                    new State("Close Bridge3",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shtrs Bridge Closer 3", "Closer"),
                        new TimedTransition(50, "Close Bridge4")
                        ),
                    new State("Close Bridge4",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shtrs Bridge Closer 4", "Closer"),
                        new TimedTransition(60, "BEGIN")
                        ),
                    new State("BEGIN",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        ...
                        new State("Suicide",
                            ...
                            new Order(100, "shtrs Chest Spawner 1", "Open"),
            ...
            .Init("shtrs Twilight Archmage",
                new State(
                    ...
                    new State("Wake",
                        ...
                        new SetAltTexture(1),
                        new State("Comment2",
                            new Order(200,"shtrs Spawn Bridge 2", "CloseBridge2"),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
        ...
        #region BridgeStatues
            .Init("shtrs Bridge Obelisk A",
                new State(
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new EntityNotExistsTransition("Shtrs Bridge Closer", 100, "TALK")
                        ),
                    new State("TALK",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
            ...
            .Init("shtrs Bridge Obelisk C",                                                     //YELLOW TOWERS!
                new State(
                    new State("Idle",
                        ...
                        new EntityNotExistsTransition("Shtrs Bridge Closer", 100, "JustKillMe")
                        ),
        ...
        .Init("shtrs Bridge Closer",
            new State(
                ...
                new State("Closer",
                    new ChangeGround(new[] { "shtrs Bridge" }, new[] { "shtrs Pure Evil" },
                        1),
                    new SpecificBehavior("bridge 1 suicide", 0),
                    new SpecificBehavior("close bridge 1", 3),

                    new TimedTransition(100, "KeepMoving")

                    ),
                new State("KeepMoving",
                    new EntityNotExistsTransition("shtrs Bridge Obelisk A", 300, "Idle"),
                    new TimedTransition(5000, "Closer")
                    ),
                new State("Suicide",
                    new Suicide()
                    ),
        ...
        .Init("shtrs Bridge Closer 2",
            new State(
                new State("Idle",
                    new ConditionalEffect(ConditionEffectIndex.Invincible, true)
                    ),
                new State("Open",
                    new ChangeGroundOnDeath(new[] { "Dark Cobblestone" }, new[] {"Hot Lava"},1),
                    new Suicide()
                    )
            )
            )
        .Init("shtrs Bridge Closer 3",
            new State(
                new State("Idle",
                    new ConditionalEffect(ConditionEffectIndex.Invincible, true)
                    ),
        ...
        .Init("shtrs Spawn Bridge",
            new State(
                new State("Idle",
                    new ConditionalEffect(ConditionEffectIndex.Invincible, true),
                    new EntityNotExistsTransition("shtrs Bridge Sentinel", 200, "Open")
                    ),
                new State("Open",
        ...
        .Init("shtrs Spawn Bridge 2",
            new State(
                ...
                new State("Open",
                    new ChangeGround(new[] { "shtrs Pure Evil" }, new[] { "shtrs Shattered Floor" },
                        1)
                    ),
        ...
        #region 3rdboss
            .Init("shtrs The Forgotten King",
                new State(
                    ...
                    new State("1st",
                        new Order(200,"shtrs Bridge Closer 2","Open"),
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new ConditionalEffect(ConditionEffectIndex.Invisible),
                        new ConditionalEffect(ConditionEffectIndex.Stasis),
