...
namespace wServer.realm.entities.player
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        //currentinvite doubles as the party leader, if in a party this will be party leader, else the last invite sent.
            ...
            : base(manager, (ushort)psr.Character.ObjectType, psr.Random)
        {
            try
            {
                ...
                Client = psr;
                inParty=psr.Character.inParty==1 ? true:false;
                party = psr.Character.party;
                currentinvite = psr.Character.currentinvite;
